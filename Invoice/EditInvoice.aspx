<%@ Page Language="C#" Inherits="MicroErp.EditInvoice" CodeFile="Businesslogic/EditInvoice.aspx.cs" %>
    <!DOCTYPE>
    <html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="Styles/EditInvoice.css">
    ...
    <body>
        <div class="MainHeader">
            <div class="Heading">
                ...
                <h2 style="display: inline;">Edit Invoice</h2>
            </div>
        </div>
